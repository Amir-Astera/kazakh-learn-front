        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="auth-form-row">
            <div className="auth-form-row-left">
              <input type="checkbox" id="rem-login" checked={remember}
                onChange={e => setRemember(e.target.checked)} />
              <label htmlFor="rem-login">Запомнить меня</label>
            </div>
            <button type="button" className="auth-form-forgot">Забыли пароль?</button>
          </div>
